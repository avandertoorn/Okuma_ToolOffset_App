...
{
    public class MountedBlockPosition : IBlockPosition
    {
        private int _id;
        ...
        private Tool _MountedTool;
        private int _offsetNumber;
        ...
        public Tool MountedTool
        {
            get { return _MountedTool; }
            set
            {
                if (value != _MountedTool)
                    _MountedTool = value;
            }
        }
        ...
        {
            get { return _offsetNumber; }
            set
            {
                if (value != _offsetNumber)
                    _offsetNumber = value;
            }
        }
    }
